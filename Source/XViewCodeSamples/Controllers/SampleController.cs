...
using XViewCodeSamples.DecorationFilters;
using XViewCodeSamples.ValidationFilters;
...
namespace XViewCodeSamples.Controllers
{
    ...
    /// </summary>
    public class SampleController : Controller<SampleContext>
    {
        /// <summary>
        ...
        protected override void InitializeViewRequest()
        {
            ...
            this.RegisterOutputFilter(new CountryAndLanguageCodesDecorationFilter(this.Context));
        ...
        /// </summary>
        protected override ControllerView<SampleContext> GetCustomControllerView()
        {
            return new CustomControllerView(this.Context);
        }
        ...
        {
            return new CustomViewMapper(this.GetRootNamespace());
        }
