...
namespace XViewCodeSamples.Views.CodeSampleViews
{
    public class PageScopeView : View<Component>
    {
        protected override string Render()
        {
            ...
            // check out the method SampleContext.GetCustomPageScope() and the accompanying 
            ...
            if (this.Context.PageScope.Contains("SkipRender"))
            {
            ...
            this.Context.PageScope.Set("SkipRender", true);
